...
public enum ResponseValue {
    ...
    SALESMAN_NOT_FOUND(HttpStatus.NOT_FOUND, 40401, "không tìm thấy người bán"),
    CUSTOMER_NOT_FOUND(HttpStatus.NOT_FOUND, 40402, "không tìm thấy người mua"),
    PROMOTION_PRODUCT_NOT_FOUND(HttpStatus.NOT_FOUND, 40403, "không tìm thấy sản phẩm khuyến mãi"),
